...
public class InfluxDBUtil {
    ...
    public static void main(String[] args) {
        InfluxDBUtil influx = new InfluxDBUtil("admin", "admin", "http://112.13.167.87:9004", "ngtest", "");
//        QueryResult result = influx.query("select * from test");
        Map<String, Object> fields = new HashMap<String, Object>();
        fields.put("field1", "StringVAlue");
        ...
        // 时间使用毫秒为单位
        influx.insert("table1", influx.getTags(), fields, System.currentTimeMillis(), TimeUnit.MILLISECONDS);
        influx.close();
    }
}
