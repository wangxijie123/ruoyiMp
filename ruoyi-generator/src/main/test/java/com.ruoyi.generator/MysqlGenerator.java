...
//    private static String mysql_password = "junction@123";
//    private static String mysql_url = "jdbc:mysql://weixin.junction.com.cn:20087/lightweight_network_management?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
//    private static String table="interface_data";                  //table名字
//    private static String prefix="";                     //table前缀
//    private static String packageName="qlhwg";    //文件路径
